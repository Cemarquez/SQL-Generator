...
public class MPackageImpl extends EObjectImpl implements MPackage {
	...
	protected EClass eStaticClass() {
		return ConcretePackage.Literals.MPACKAGE;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConcretePackage.MPACKAGE__NAME, oldName, name));
	}
	...
	public void setPath(String newPath) {
		...
		path = newPath;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConcretePackage.MPACKAGE__PATH, oldPath, path));
	}
