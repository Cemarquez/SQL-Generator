...
/**
 * This is the item provider adapter for a {@link concrete.MClassDiagram} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MClassDiagramItemProvider 
	 ...
	 * @generated
	 */
	public MClassDiagramItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_MClassDiagram_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_MClassDiagram_name_feature", "_UI_MClassDiagram_type"),
				 ConcretePackage.Literals.MCLASS_DIAGRAM__NAME,
				 true,
				 false,
				 false,
	...
	/**
	 * This returns MClassDiagram.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/MClassDiagram"));
	}
	...
	public String getText(Object object) {
		String label = ((MClassDiagram)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_MClassDiagram_type") :
			getString("_UI_MClassDiagram_type") + " " + label;
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ConcretePackage.Literals.MCLASS_DIAGRAM__LST_MPACKAGE,
				 ConcreteFactory.eINSTANCE.createMPackage()));

		newChildDescriptors.add
			(createChildParameter
				(ConcretePackage.Literals.MCLASS_DIAGRAM__LST_MCLASS,
				 ConcreteFactory.eINSTANCE.createMClass()));
