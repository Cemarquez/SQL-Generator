 ...
 * </p>
 * <ul>
 *   <li>{@link sql_abstracts.impl.ModelFactoryImpl#getLstSchema <em>Lst Schema</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ModelFactoryImpl extends EObjectImpl implements ModelFactory {
	...
	protected EClass eStaticClass() {
		return Sql_abstractsPackage.Literals.MODEL_FACTORY;
	}
	...
	public EList<Schema> getLstSchema() {
		if (lstSchema == null) {
			lstSchema = new EObjectContainmentEList<Schema>(Schema.class, this, Sql_abstractsPackage.MODEL_FACTORY__LST_SCHEMA);
		}
		return lstSchema;
	}
