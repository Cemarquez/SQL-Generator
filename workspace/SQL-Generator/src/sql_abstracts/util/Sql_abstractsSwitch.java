 ...
 * @generated
 */
public class Sql_abstractsSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case Sql_abstractsPackage.MODEL_ELEMENT: {
				ModelElement modelElement = (ModelElement)theEObject;
				T result = caseModelElement(modelElement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Sql_abstractsPackage.TABLE: {
			...
			case Sql_abstractsPackage.COLUMN: {
			...
			case Sql_abstractsPackage.PRIMARY_KEY: {
			...
			case Sql_abstractsPackage.FOREIGN_KEY: {
