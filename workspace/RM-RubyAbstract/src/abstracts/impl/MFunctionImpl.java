 ...
 * </p>
 * <ul>
 *   <li>{@link abstracts.impl.MFunctionImpl#getName <em>Name</em>}</li>
 *   <li>{@link abstracts.impl.MFunctionImpl#getAccessModifier <em>Access Modifier</em>}</li>
 *   <li>{@link abstracts.impl.MFunctionImpl#getSemantics <em>Semantics</em>}</li>
 *   <li>{@link abstracts.impl.MFunctionImpl#getComments <em>Comments</em>}</li>
 *   <li>{@link abstracts.impl.MFunctionImpl#getParameters <em>Parameters</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MFunctionImpl extends EObjectImpl implements MFunction {
	...
	protected EClass eStaticClass() {
		return AbstractsPackage.Literals.MFUNCTION;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AbstractsPackage.MFUNCTION__NAME, oldName, name));
	}
	...
	public void setAccessModifier(String newAccessModifier) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AbstractsPackage.MFUNCTION__ACCESS_MODIFIER, oldAccessModifier, accessModifier));
	}
	...
	public void setSemantics(String newSemantics) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AbstractsPackage.MFUNCTION__SEMANTICS, oldSemantics, semantics));
	}
	...
	public void setComments(String newComments) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AbstractsPackage.MFUNCTION__COMMENTS, oldComments, comments));
	}
	...
	public void setParameters(String newParameters) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AbstractsPackage.MFUNCTION__PARAMETERS, oldParameters, parameters));
	}
