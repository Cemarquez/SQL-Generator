...
/**
 * This is the item provider adapter for a {@link sql_abstracts.ForeignKey} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ForeignKeyItemProvider extends ModelElementItemProvider {
	/**
	...
	/**
	 * This adds a property descriptor for the Refer Primary Key feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addReferPrimaryKeyPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ForeignKey_referPrimaryKey_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ForeignKey_referPrimaryKey_feature", "_UI_ForeignKey_type"),
				 Sql_abstractsPackage.Literals.FOREIGN_KEY__REFER_PRIMARY_KEY,
				 true,
				 false,
				 true,
				 null,
