 ...
 * @generated
 */
public class MInheritanceReorientCommand extends EditElementCommand {
	...
	* @generated
	*/
	public MInheritanceReorientCommand(ReorientRelationshipRequest request) {
	...
	*/
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof MInheritance) {
			return false;
		}
	...
	*/
	protected boolean canReorientSource() {
		...
		return ConcreteBaseItemSemanticEditPolicy.getLinkConstraints().canExistMInheritance_4002(container, getLink(),
				getNewSource(), target);
	}
	...
	* @generated
	*/
	protected MInheritance getLink() {
		return (MInheritance) getElementToEdit();
	}
