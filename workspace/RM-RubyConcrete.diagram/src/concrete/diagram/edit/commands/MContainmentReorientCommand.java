 ...
 * @generated
 */
public class MContainmentReorientCommand extends EditElementCommand {
	...
	* @generated
	*/
	public MContainmentReorientCommand(ReorientRelationshipRequest request) {
	...
	*/
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof MContainment) {
			return false;
		}
	...
	*/
	protected boolean canReorientSource() {
		...
		return ConcreteBaseItemSemanticEditPolicy.getLinkConstraints().canExistMContainment_4003(container, getLink(),
				getNewSource(), target);
	}
	...
	* @generated
	*/
	protected MContainment getLink() {
		return (MContainment) getElementToEdit();
	}
