 ...
 * @generated
 */
public class MPackageNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public MPackageNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ConcreteParserProvider.getParser(ConcreteElementTypes.MPackage_2001, getParserElement(),
					ConcreteVisualIDRegistry.getType(concrete.diagram.edit.parts.MPackageNameEditPart.VISUAL_ID));
		}
		return parser;
	}
