 ...
 * @generated
 */
public class MAttributeEditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public MAttributeEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new MAttributeItemSemanticEditPolicy());
	...
	*/
	protected IFigure createNodeShape() {
		return primaryShape = new MAttributeFigure();
	}

	/**
	* @generated
	*/
	public MAttributeFigure getPrimaryShape() {
		return (MAttributeFigure) primaryShape;
	}
	...
	*/
	 ...
	 * @generated
	 */
	public class MAttributeFigure extends RectangleFigure {

		/**
		 * @generated
		 */
		private WrappingLabel fFigureMAttributeLabelFigure;

		/**
		 * @generated
		 */
		public MAttributeFigure() {
		...
		private void createContents() {
			...
			fFigureMAttributeLabelFigure = new WrappingLabel();

			fFigureMAttributeLabelFigure.setText("MAttribute");

			this.add(fFigureMAttributeLabelFigure);
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureMAttributeLabelFigure() {
			return fFigureMAttributeLabelFigure;
		}
