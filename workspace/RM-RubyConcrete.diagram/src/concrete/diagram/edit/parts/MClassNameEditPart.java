 ...
 * @generated
 */
public class MClassNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public MClassNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ConcreteParserProvider.getParser(ConcreteElementTypes.MClass_2002, getParserElement(),
					ConcreteVisualIDRegistry.getType(concrete.diagram.edit.parts.MClassNameEditPart.VISUAL_ID));
		}
		return parser;
	}
