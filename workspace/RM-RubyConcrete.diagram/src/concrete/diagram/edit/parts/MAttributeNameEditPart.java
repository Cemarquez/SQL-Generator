 ...
 * @generated
 */
public class MAttributeNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public MAttributeNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ConcreteParserProvider.getParser(ConcreteElementTypes.MAttribute_3001, getParserElement(),
					ConcreteVisualIDRegistry.getType(concrete.diagram.edit.parts.MAttributeNameEditPart.VISUAL_ID));
		}
		return parser;
	}
