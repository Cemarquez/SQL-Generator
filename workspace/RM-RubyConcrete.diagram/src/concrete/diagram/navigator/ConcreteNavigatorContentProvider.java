	...
	*/
	public Object[] getChildren(Object parentElement) {
		if (parentElement instanceof IFile) {
			...
			result.addAll(
					createNavigatorItems(selectViewsByType(topViews, MClassDiagramEditPart.MODEL_ID), file, false));
	...
	private Object[] getViewChildren(View view, Object parentElement) {
		...
		case MClassDiagramEditPart.VISUAL_ID: {
			...
			ConcreteNavigatorGroup links = new ConcreteNavigatorGroup(
					Messages.NavigatorGroupName_MClassDiagram_1000_links, "icons/linksNavigatorGroup.gif", //$NON-NLS-1$
					parentElement);
			Collection<View> connectedViews;
			connectedViews = getChildrenByType(Collections.singleton(sv),
					ConcreteVisualIDRegistry.getType(MPackageEditPart.VISUAL_ID));
		...
		case MClassEditPart.VISUAL_ID: {
			...
			ConcreteNavigatorGroup incominglinks = new ConcreteNavigatorGroup(
					Messages.NavigatorGroupName_MClass_2002_incominglinks, "icons/incomingLinksNavigatorGroup.gif", //$NON-NLS-1$
					parentElement);
			ConcreteNavigatorGroup outgoinglinks = new ConcreteNavigatorGroup(
					Messages.NavigatorGroupName_MClass_2002_outgoinglinks, "icons/outgoingLinksNavigatorGroup.gif", //$NON-NLS-1$
					parentElement);
			Collection<View> connectedViews;
			connectedViews = getChildrenByType(Collections.singleton(sv),
					ConcreteVisualIDRegistry.getType(MClassMClassLstMAttributeCompartmentEditPart.VISUAL_ID));
			connectedViews = getChildrenByType(connectedViews,
					ConcreteVisualIDRegistry.getType(MAttributeEditPart.VISUAL_ID));
			result.addAll(createNavigatorItems(connectedViews, parentElement, false));
			connectedViews = getChildrenByType(Collections.singleton(sv),
		...
		case MAssociationEditPart.VISUAL_ID: {
			...
			ConcreteNavigatorGroup target = new ConcreteNavigatorGroup(
					Messages.NavigatorGroupName_MAssociation_4001_target, "icons/linkTargetNavigatorGroup.gif", //$NON-NLS-1$
					parentElement);
			ConcreteNavigatorGroup source = new ConcreteNavigatorGroup(
					Messages.NavigatorGroupName_MAssociation_4001_source, "icons/linkSourceNavigatorGroup.gif", //$NON-NLS-1$
					parentElement);
			Collection<View> connectedViews;
		...
		case MInheritanceEditPart.VISUAL_ID: {
			...
			Edge sv = (Edge) view;
			ConcreteNavigatorGroup target = new ConcreteNavigatorGroup(
					Messages.NavigatorGroupName_MInheritance_4002_target, "icons/linkTargetNavigatorGroup.gif", //$NON-NLS-1$
					parentElement);
			ConcreteNavigatorGroup source = new ConcreteNavigatorGroup(
					Messages.NavigatorGroupName_MInheritance_4002_source, "icons/linkSourceNavigatorGroup.gif", //$NON-NLS-1$
					parentElement);
			Collection<View> connectedViews;
			connectedViews = getLinksTargetByType(Collections.singleton(sv),
					ConcreteVisualIDRegistry.getType(MClassEditPart.VISUAL_ID));
		...
		case MContainmentEditPart.VISUAL_ID: {
			...
			Edge sv = (Edge) view;
			ConcreteNavigatorGroup target = new ConcreteNavigatorGroup(
					Messages.NavigatorGroupName_MContainment_4003_target, "icons/linkTargetNavigatorGroup.gif", //$NON-NLS-1$
					parentElement);
			ConcreteNavigatorGroup source = new ConcreteNavigatorGroup(
					Messages.NavigatorGroupName_MContainment_4003_source, "icons/linkSourceNavigatorGroup.gif", //$NON-NLS-1$
					parentElement);
			Collection<View> connectedViews;
			connectedViews = getLinksTargetByType(Collections.singleton(sv),
					ConcreteVisualIDRegistry.getType(MClassEditPart.VISUAL_ID));
